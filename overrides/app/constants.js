...
export const CUSTOM_HOME_TITLE = '🎉 Hello Extensible React Template! Hhhh'

export const SFRA_HOME_TITLE = "Welcome"

export const CUSTOM_HOME_BANNER_TITLE = "Welcome to Salesforce"
